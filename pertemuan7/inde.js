...
//STRING LITERAL
// Hallo nama saya Jose, Umur 19 Tahun
...
console.log (sayHello3("Jose","Jeremy"));

//DEFAULT PARAMETER
const defaultParameter =(param1,param2 = "Jeremy",param3) => `Ini Default Param ${param1} ${param2}`
console.log(defaultParameter("Jose"));
